...
public class OntologyManager {
	...
	public IRI getIRI() {
		return getOWLOntology().getOntologyID().getOntologyIRI().get();
	}
	...
	public Set<OWLDataProperty> getDataPropertiesByDomainExtended(OWLClass domain) {
		Log.getLog().debug(
				"<OntologyManager:getDataPropertiesByDomainExtended> Buscando DataProperties con dominio "
	...
	public boolean isDomainOfDataProperty(OWLClass clase, OWLDataProperty prop) {
		...
		for (OWLClass owlClass1 : owlReasoner.getDataPropertyDomains(prop, false).getFlattened()) {
			if (owlClass1.getIRI().equals(clase.getIRI())) {
				Log.getLog().debug(
						"<OntologyManager:idDomainOfDataProperty> " + clase.getIRI().getFragment() + " dominio de "
								+ prop.getIRI().getFragment() + "?     SI!");
				return true;
				// } else {
				// for(OWLClass owlClass2 : owlReasoner.getSuperClasses(clase, false).getFlattened()) {
				// if(owlClass2.getIRI().equals(owlClass1.getIRI())) {
				// Log.getLog().debug("<OntologyManager:idDomainOfDataProperty> "+clase.getIRI().getFragment() +
				// " dominio de " + prop.getIRI().getFragment() + "?     SI!");
				// return true;
				// }
				// }
			}
	...
	public boolean isDomainOrRangeOfObjectProperty(OWLClass clase, OWLObjectProperty prop) {
		...
		for (OWLClass owlClass1 : owlReasoner.getObjectPropertyDomains(prop, false).getFlattened()) {
			if (owlClass1.getIRI().equals(clase.getIRI())) {
				Log.getLog().debug(
						"<OntologyManager:isDomainOrRangeOfObjectProperty>1 " + clase.getIRI().getFragment()
								+ " dominio o rango de " + prop.getIRI().getFragment() + "?      SI!");
				return true;
				// } else {
				// for(OWLClass owlClass2 : owlReasoner.getSuperClasses(clase, false).getFlattened()) {
				// if(owlClass2.getIRI().equals(owlClass1.getIRI())) {
				// Log.getLog().debug("<OntologyManager:isDomainOrRangeOfObjectProperty>2 "+clase.getIRI().getFragment()
				// + " dominio o rango de " + prop.getIRI().getFragment() + "?      SI!");
				// return true;
				// }
				// }
		...
		for (OWLClass owlClass1 : owlReasoner.getObjectPropertyRanges(prop, false).getFlattened()) {
			if (owlClass1.getIRI().equals(clase.getIRI())) {
				Log.getLog().debug(
						"<OntologyManager:isDomainOrRangeOfObjectProperty>3 " + clase.getIRI().getFragment()
								+ " dominio o rango de " + prop.getIRI().getFragment() + "?      SI!");
				return true;
				// } else {
				// for(OWLClass owlClass2 : owlReasoner.getSuperClasses(clase, false).getFlattened()) {
				// if(owlClass2.getIRI().equals(owlClass1.getIRI())) {
				// Log.getLog().debug("<OntologyManager:isDomainOrRangeOfObjectProperty>4 "+clase.getIRI().getFragment()
				// + " dominio o rango de " + prop.getIRI().getFragment() + "?      SI!");
				// return true;
				// }
				// }
		...
		Log.getLog().debug(
				"<OntologyManager:isDomainOrRangeOfObjectProperty> " + clase.getIRI().getFragment()
						+ " dominio o rango de " + prop.getIRI().getFragment() + "? NO");
		return false;
	}
	...
	public Set<OWLClass> getClassEquivalents(OWLClass clase) {
		Set<OWLClass> classSet = new HashSet<OWLClass>();
		for (OWLEquivalentClassesAxiom eca : ont.getEquivalentClassesAxioms(clase)) {
	...
	public Set<OWLObjectProperty> getObjectPropertyEquivalents(OWLObjectProperty prop) {
		Set<OWLObjectProperty> propSet = new HashSet<OWLObjectProperty>();
		for (OWLEquivalentObjectPropertiesAxiom eopa : ont.getEquivalentObjectPropertiesAxioms(prop)) {
