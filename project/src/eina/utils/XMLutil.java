...
//    @Deprecated
//    static public String articleListToXml(List<Articulo> articleList) {
//        String out = "";
//
//        try {
//
...
//                nodeURI.appendChild(nodeURIText);
//
//                Set<String> labels = articleList.get(i).getLabels();
//                for (String label : labels) {
//                    Element nodeLabel = doc.createElement("label");
//                    child.appendChild(nodeLabel);
//                    Text nodeLabelText = doc.createTextNode(label);
//                    nodeLabel.appendChild(nodeLabelText);
//                }
//
//                Set<String> abstracts = articleList.get(i).getAbstracts();
//                for (String abstracto : abstracts) {
//                    Element nodeAbstract = doc.createElement("abstract");
//                    child.appendChild(nodeAbstract);
//                    Text nodeAbstractText = doc.createTextNode(abstracto);
//                    nodeAbstract.appendChild(nodeAbstractText);
//                }
//
//                Element nodePage = doc.createElement("page");
//                child.appendChild(nodePage);
//                Text nodePageText = doc.createTextNode(articleList.get(i).getWeb());
//                nodePage.appendChild(nodePageText);
//
//            }
//
//            //Output the XML
...
//                nodeURI.appendChild(nodeURIText);
    ...
    /**
     * Transforma un {@link JResult} en un XML adecuado para su consumo a través
     * del servicio web. A cada nodo/elemento devuelto se le añade una hoja
     * <tipo> con el valor de la entrada "nombreClase".
     * <p>
     * Usar {@link #resultsSetsToXml(java.util.Map) } en vez de éste.
     *
     * @param nombreClase Tipo del recurso que se transforma en XML
     * @param rs {@link JResult}
