...
public class DocumentUtils {
  ...
  public static Document createResourceDocument(SResource article, String categoryName) {
    Document doc = new Document();
  ...
  public static Set<Document> createResourceDocuments(Set<SResource> articleSet, String categoryName) {
