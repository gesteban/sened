...
public class DomainOntology {
    ...
    static {
        ...
        taxonomyDefinedBy = _ontology
                .getOntProperty(BASE_URI + "taxonomyDefinedBy");
    ...
    public static org.apache.jena.rdf.model.Resource createResource(
            String uri) {
    ...
    public static void main(String[] args) {
        Log.i(TAG, DomainOntology
                .createClass("http://sened.unizar.es/def#Voids").toString());
    }
